  ...
  return (
    <Panel title="Setting Velocity" defaultOpen={false}>
      <div className="space-y-3 text-xs text-zinc-400">
        ...
        <p>
          <span className="text-zinc-300">1.</span> Select a waypoint by
          clicking it in the 3D view or waypoint list.
        </p>
        <p>
          <span className="text-zinc-300">2.</span> In the Waypoints panel, use
          the <span className="text-cyan-400">Arrival Velocity</span> dropdown.
        </p>
        <p>
          <span className="text-zinc-300">3.</span> Choose a preset or select{" "}
